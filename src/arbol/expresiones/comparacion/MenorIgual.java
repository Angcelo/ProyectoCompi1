...
public class MenorIgual extends Expresion{
    ...
    public MenorIgual(Expresion izquierda, Expresion derecho, int linea, int columna) {
    ...
    public Expresion getValor(Entorno ent) {
        ...
        if (literal.tipo.tipo==Tipo.EnumTipo.error) {
            cError errora=new cError("Semantico","No se puede aplciar menor o igual que "+exp1.tipo.tipo+" entre "+exp2.tipo.tipo,linea,columna);
