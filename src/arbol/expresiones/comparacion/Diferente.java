...
public class Diferente extends Expresion {
    ...
    public Diferente(Expresion izquierda, Expresion derecho, int linea, int columna) {
    ...
    public Expresion getValor(Entorno ent) {
        ...
        if (literal.tipo.tipo==Tipo.EnumTipo.error) {
            cError errora=new cError("Semantico","No se puede hacer diferencia "+exp1.tipo.tipo+" entre "+exp2.tipo.tipo,linea,columna);
