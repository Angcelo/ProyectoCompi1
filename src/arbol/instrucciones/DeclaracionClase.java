...
public class DeclaracionClase extends Instruccion{
    ...
    public DeclaracionClase(String clase,String nombre,boolean declarar,int linea,int columna){
        this.nombre=nombre;
        this.clase=clase;
    ...
    public DeclaracionClase(String clase,String nombre,LinkedList<Expresion> parametros,String clase2,boolean declarar,int linea,int columna){
        this.nombre=nombre;
        this.clase=clase;
        this.clase2=clase2;
    ...
    public Object ejecutar(Entorno ent) {
        ...
        if (ProyectCompi1.L_clases.containsKey(clase)) {
            ...
            ent.insertar(nombre, sim, linea, columna, "La clase");
        }else{
